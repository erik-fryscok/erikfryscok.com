...
const proofDescriptions = [
  "A learning and evaluation environment for local and open-weight models, exploring routing, compatibility, benchmarks, and when frontier cloud models remain the better choice.",
...
test("Home leads with practical AI systems and ordered, calibrated proof", async () => {
  ...
  const localLabPosition = html.indexOf(">Local AI Lab</h3>");
  ...
  assert.ok(localLabPosition >= 0, "expected Local AI Lab proof on Home");
